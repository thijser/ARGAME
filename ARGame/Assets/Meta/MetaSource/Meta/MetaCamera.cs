...
namespace Meta
{
	public class MetaCamera : RenderingCameraManagerBase
	{
		...
		public static bool IsVisible(Bounds bounds)
		{
			...
			{
				return GeometryUtility.TestPlanesAABB(GeometryUtility.CalculateFrustumPlanes(UnityEngine.Camera.main), bounds);
			}
			return GameObject.Find("MetaCameraLeft") != null && GameObject.Find("MetaCameraRight") != null && (GeometryUtility.TestPlanesAABB(GeometryUtility.CalculateFrustumPlanes(GameObject.Find("MetaCameraLeft").GetComponent<UnityEngine.Camera>()), bounds) || GeometryUtility.TestPlanesAABB(GeometryUtility.CalculateFrustumPlanes(GameObject.Find("MetaCameraRight").GetComponent<UnityEngine.Camera>()), bounds));
		}
