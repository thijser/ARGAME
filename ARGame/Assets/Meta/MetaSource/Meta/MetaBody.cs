	...
	public class MetaBody : MonoBehaviour
	{
		...
		public bool grabbable
		{
			...
			set
			{
				...
				{
					MetaSingleton<MetaManager>.Instance.AddRemoveInteractable(InteractableType.Grabbable, base.transform, value);
				}
			}
		}
		...
		public bool scaleObjectOnGrab
		{
			...
			set
			{
				...
				if (value)
				{
					this._rotateObjectOnGrab = false;
					this._moveObjectOnGrab = false;
					if (Application.isPlaying && !this._minMaxScaleSet)
					{
						this.minScale = base.transform.localScale * this.minScaleRatio;
						this.maxScale = base.transform.localScale * this.maxScaleRatio;
		...
		public bool pinchable
		{
			...
			set
			{
				...
				if (MetaSingleton<MetaManager>.Instance != null)
				{
					MetaSingleton<MetaManager>.Instance.AddRemoveInteractable(InteractableType.Pinchable, base.transform, value);
				}
			}
		}
		...
		public bool touchable
		{
			...
			set
			{
				...
				if (MetaSingleton<MetaManager>.Instance != null)
				{
					MetaSingleton<MetaManager>.Instance.AddRemoveInteractable(InteractableType.Touchable, base.transform, value);
				}
			}
		}
		...
		public bool pointable
		{
			...
			set
			{
				...
				if (MetaSingleton<MetaManager>.Instance != null)
				{
					MetaSingleton<MetaManager>.Instance.AddRemoveInteractable(InteractableType.Pointable, base.transform, value);
				}
			}
		}
		...
		public bool jaysify
		{
			...
			set
			{
				...
				if (this._jaysify)
				{
					...
					{
						base.gameObject.AddComponent<VectorMeshObject>();
					...
					{
						base.GetComponent<VectorMeshObject>().enabled = true;
					}
				}
				else if (base.GetComponent<VectorMeshObject>() != null)
				{
					base.GetComponent<VectorMeshObject>().enabled = false;
				}
			}
		}
		...
		public bool arrow
		{
			...
			set
			{
				...
				{
					MetaSingleton<MetaArrow>.Instance.targetTransform = base.transform;
				}
			}
		}
		...
		public bool canvasTarget
		{
			...
			set
			{
				...
				if (MetaSingleton<MetaManager>.Instance != null)
				{
					MetaSingleton<MetaManager>.Instance.AddRemoveInteractable(InteractableType.CanvasTarget, base.transform, this._canvasTarget);
				}
				if (this._canvasTarget)
				{
					if (base.GetComponent<CanvasTarget>() == null)
					{
						base.gameObject.AddComponent<CanvasTarget>();
					}
					else
					{
						base.GetComponent<CanvasTarget>().enabled = true;
					}
				}
				else if (base.GetComponent<CanvasTarget>() != null)
				{
					base.GetComponent<CanvasTarget>().enabled = false;
				}
			}
		}
		...
		public bool markerTarget
		{
			...
			set
			{
				...
				if (MetaSingleton<MetaManager>.Instance != null)
				{
					MetaSingleton<MetaManager>.Instance.AddRemoveInteractable(InteractableType.MarkerTarget, base.transform, this._markerTarget);
				}
				if (this._markerTarget)
				{
					if (base.GetComponent<MarkerTarget>() == null)
					{
						base.gameObject.AddComponent<MarkerTarget>();
					}
					else
					{
						base.GetComponent<MarkerTarget>().enabled = true;
					}
					this.markerTargetID = this._markerTargetID;
				}
				else if (base.GetComponent<MarkerTarget>() != null)
				{
					base.GetComponent<MarkerTarget>().enabled = false;
				}
			}
		}
		...
		private void ManageMetaTransform()
		{
			if (this.hud || this.orbital || this.palmLock || this.fingerLock)
			{
				if (base.GetComponent<MetaTransform>() == null)
				{
					base.gameObject.AddComponent<MetaTransform>();
				}
				else
				{
					base.GetComponent<MetaTransform>().enabled = true;
				}
			}
			else if (base.GetComponent<MetaTransform>() != null)
			{
				base.GetComponent<MetaTransform>().enabled = false;
			}
		}

		public int GetPersistentMarkerTargetID()
		{
			return PlayerPrefs.GetInt(Application.loadedLevelName + "." + base.gameObject.name);
		}

		public void SetPersistentMarkerTargetID(int idToSet)
		{
			PlayerPrefs.SetInt(Application.loadedLevelName + "." + base.gameObject.name, idToSet);
		}
