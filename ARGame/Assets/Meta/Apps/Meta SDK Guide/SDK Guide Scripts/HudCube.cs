...
namespace Meta.Apps.MetaSDKGuide
{
    ...
    public class HudCube : MonoBehaviour
    {
        ...
        public void SetHudCubePos()
        {
            ...
            {
                _hudCube.transform.position = UnityEngine.Camera.main.transform.position;
                _hudCube.transform.Translate(UnityEngine.Camera.main.transform.forward * 0.4f, relativeTo: Space.World);
            }
        }
    }
