...
namespace Meta
{
  internal class KeyboardShortcuts : MetaSingleton<KeyboardShortcuts>
  {
    ...
    private void Start()
    {
      if (Object.op_Inequality((Object) MetaSingleton<RenderingCameraManagerBase>.Instance, (Object) null))
    ...
    private void CheckDuplicate(string key, ref string keyRef)
    {
      ...
      {
        Debug.LogError((object) ("Multiple functions defined for single shortcut key: " + key));
        keyRef = string.Empty;
      }
    }
    ...
    private void Update()
    {
      ...
      if (this._toggleWideRectified != string.Empty && Input.GetKeyDown(this._toggleWideRectified))
      {
        if (MetaCore.Instance.trueScale)
        {
          ...
          if (Object.op_Inequality((Object) MetaSingleton<MetaUserSettingsManager>.Instance, (Object) null) && Object.op_Inequality((Object) MetaSingleton<MetaUserSettingsManager>.Instance.m_myUserProfile, (Object) null) && Object.op_Inequality((Object) MetaSingleton<MetaUserSettingsManager>.Instance.m_myUserProfile.m_widescaleCameraProfile, (Object) null))
        ...
        {
          MetaCamera.SetAllowRealTimeSettingsUpdate(true);
          if (Object.op_Inequality((Object) MetaSingleton<MetaUserSettingsManager>.Instance, (Object) null) && Object.op_Inequality((Object) MetaSingleton<MetaUserSettingsManager>.Instance.m_myUserProfile, (Object) null) && Object.op_Inequality((Object) MetaSingleton<MetaUserSettingsManager>.Instance.m_myUserProfile.m_truescaleCameraProfile, (Object) null))
      ...
      if (this._reload != string.Empty && Input.GetKeyDown(this._reload))
        MetaCore.LoadScene(Application.get_loadedLevel(), true);
