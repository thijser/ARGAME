...
\pagenumbering{arabic}
  ...
  \section{Software Design Methods} \label{sec:designmethods}
    ...
    \section{Process}\label{sec:process}
      ...
      we wanted to move from the original project to the new project.
      ...
      \begin{table}[!ht]
	      \begin{tabular}{| c | c | c | c | c | c | c | c | c | c | c |}
	      	      ...
	      	      \hline
	      	      Final report & \space & \space & \space & X & X & X & \space & \space & \space & \space \\
	      	      \hline
	      	      Networking & X & X & \space & \space & X & X & \space & \space & \space & \space \\
	      	      \hline
	      	      Augmented reality & \space & \space & \space & X & X & X & \space & \space & \space & \space \\
	      	      \hline
	      	      Gameplay & X & X & X & X & \space & \space & \space & \space & \space & \space \\
	      	      \hline
	      	      Testing & \space & \space & X & X & X & X & \space & \space & \space & \space \\
	      	      \hline
	      \end{tabular}
      \end{table}
