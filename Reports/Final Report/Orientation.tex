  ...
  \section{Software Design Methods} \label{sec:designmethods}
    ...
    \subsection{Design Process} \label{ssec:designprocess}
		...
		\begin{figure}
			...
			\caption{A graphical display of the Scrum methodology of software development. 
			         The methodology shown here is nearly identical to the methodology we use, 
			         the only exception being that our sprints only last one week instead of two.}
		\end{figure}
    ...
    \section{Process}\label{sec:process}
      ...
      session and a pitch session with our coach, we were shown what kind of
      hardware the TU Delft has available, and also what the limitations
      of this hardware ware.
      ...
      should be created. The rest of the week was our research phase: what
      hardware would we require, what functionality of Unity would we need,
      etc. Also, the rest of the week was dedicated to testing out various
      parts of the required software and hardware, as well as thinking of
      requirements according to the MoSCoW model.
      ...
      OpenCV started, dropping the requirement for Unity to support networking,
      as Unity had support for OpenCV and the support that Unity had for networking
      was insufficient at best.