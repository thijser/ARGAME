  ...
  \section{Software Design Methods} \label{sec:designmethods}
    ...
    \subsection{Design Process} \label{ssec:designprocess}
      ...
      \centering
	      ...
	      \caption{a graphical display of the Scrum methodology of software development. The methodology shown here is nearly identical to the methodology we use, the only exception being that our sprints only last one week instead of two.}
      \end{figure}
