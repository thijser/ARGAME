\chapter{Design} \label{cha:design}
	...
	\section{Back-end design} \label{sec:backenddesign}
		...
		The "Vision" component is responsible for containing tracked markers.
		...
		\subsection{The Vision component} \label{ssec:visioncomponent}
			...
			the component and put into another component.
			
			By design, and because of how it was conceived, the \texttt{Vision} 
			component depends heavily on the \texttt{Projection} component.
		...
		\subsection{The Level component} 
			\dots %TODO Write Level component section.
			
		\subsection{The Graphics component}
			The component that provides graphical functionality to the game.
			Since most graphics-related functions are provided by Unity, this
			component is very small, containing only very limited functionality
			that Unity did not already provide.
