\section{Proposed Solutions} \label{cha:solution}
...
\subsection{Laser mirror game} \label{sec:lasergame}
...
\subsection{Platformer} \label{sec:platformer}
...
\subsection{FPS Survival game} \label{sec:fpssurvival}
...
\subsection{Tower defense} \label{sec:towerdefense}
...
\subsection{The chosen idea} \label{sec:chosenidea}
