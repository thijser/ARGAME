\chapter{Problem Analysis} \label{cha:analysis}
	...
	\section{Augmented Reality (AR) Functionality} \label{sec:ar}
		...
		\subsection{Oculus Rift} \label{ssec:oculusrift}
			...
			The advantage of the Oculus rift camera rig is that it grands complete control
			over the screen allowing us to completely block certain regions of view, another advantage is that the field of view of the virtual world is the same as that of the 
			physical world. Disadvantages are that we must be careful not to induce any extra
			latency because that would result in the movements of the head and of the view no longer matching up, another disadvantage is that because the cameras are mounted on the front of the Oculus the field of view of the physical world is limited. 
