\chapter{Problem Analysis} \label{cha:analysis}
	...
	\section{Situational Awareness} \label{sec:awareness}
		...
		investigations (see \ref{cha:problem}). On a crime scene, the investigator
		needs to analyse and understand the situation, so there is a need for
		situational awareness in the problem description. The game will need to
		replicate a similar need for situational awareness to be an accurate
...
=======
		an asymmetry of abilities, as explained in the following subsection. 
>>>>>>> 55f56154262bc7b67868382cf0fa0c6b447d5952
...
<<<<<<< HEAD
			of the information required to complete the game.
